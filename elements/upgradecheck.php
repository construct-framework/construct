...
class JFormFieldUpgradecheck extends JFormField {
	...
	protected function getLabel()
	{
		...
		//If cURL is supported, check the current version available.
				...
				if ($version < $str)
					$message = $message . '<a href="http://construct-framework.com" target="_blank">Version 1.6.'.$str.' is now available.</a><br /><a href="http://construct-framework.com/construct-pro-1-6-changelog" target="_blank">See what&rsquo;s new</a>.</label>';
