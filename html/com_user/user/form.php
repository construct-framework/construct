...
<form action="<?php echo JRoute::_( 'index.php' ); ?>" method="post" name="userform" autocomplete="off" class="user">
	...
	<div class="user_name">
		...
		<span><?php echo htmlspecialchars($this->user->get('username')); ?></span>
	</div>
	...
	<div class="email">
		...
		<input class="inputbox required validate-email" type="text" id="email" name="email" value="<?php echo htmlspecialchars($this->user->get('email'));?>" size="40" />
	</div>
