...
<body class="<?php echo $columnLayout; if ($fontFamily) echo ' '.$fontFamily; ; if($useStickyFooter) echo ' sticky-footer'; if ($useSubBodyClasses) { echo ' '.$currentComponent.' '.$currentAlias; if($articleId) echo ' article-'.$articleId; if ($itemId) echo ' item-'.$itemId; if($catId)	echo ' category-'.$catId; if($sectionId) echo ' section-'.$sectionId;} ?>">
